...
class ProfileVideoViewerScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ProfileVideoViewerScreen> createState() => _ProfileVideoViewerScreenState();
}

class _ProfileVideoViewerScreenState extends ConsumerState<ProfileVideoViewerScreen> {
  ...
  Widget build(BuildContext context) {
    final videosState = ref.watch(
      widget.isMyVideos ? myVideosControllerProvider : myLikedVideosControllerProvider,
    );
